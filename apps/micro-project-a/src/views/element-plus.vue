<template>
  <div class='element-plus'>
    ...
    <el-dialog title="提交" v-model:visible="centerDialogVisible" width="30%" center>
      <span>提交成功</span>
    ...
    <br />
    <h1>MessageBox 弹框</h1>
    <el-button @click="MessageBoxOpen">点击打开 Message Box</el-button>
    <br />
    <br />
    <h1>Dialog 对话框</h1>
    <el-button @click="dialogVisible = true">点击打开 Dialog</el-button>
    <el-dialog title="提示" v-model:visible="dialogVisible" width="30%" :before-close="handleCloseDialog">
      <span>这是一段信息</span>
    ...
    <el-button plain @click="notifyOpen1">
      成功
    </el-button>
    <el-button plain @click="notifyOpen2">
      警告
    </el-button>
    <el-button plain @click="notifyOpen3">
      消息
    </el-button>
    <el-button plain @click="notifyOpen4">
      错误
    </el-button>
    <br />
    <br />
    ...
    <el-popover placement="top-start" title="标题" width="200" trigger="hover" content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。">
      ...
      <template v-slot:reference>
        <el-button style="margin-left: 10px;">hover 激活</el-button>
      </template>
    </el-popover>
    ...
    <el-popover placement="bottom" title="标题" width="200" trigger="click" content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。">
      ...
      <template v-slot:reference>
        <el-button style="margin-left: 10px;">click 激活</el-button>
      </template>
    </el-popover>
    ...
    <el-popover placement="bottom" title="标题" width="200" trigger="manual" content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。"
      ...
      <template v-slot:reference>
        <el-button @click="popoverVisible = !popoverVisible" style="margin-left: 10px;">手动激活</el-button>
      </template>
    </el-popover>
    ...
    <el-drawer title="我是标题" v-model:visible="drawer" :direction="direction">
      <span>我来啦!</span>
    </el-drawer>
    <br />
    <br />
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="100">
        ...
        <template v-slot="scope">
          <el-button @click="handleClickElTable(scope.row)" size="small">查看</el-button>
    ...
    <div style="width: 400px">
      ...
      <el-skeleton style="width:400px" :loading="skeletonLoading" animated :count="3">
        ...
        <template>
          <el-card :body-style="{ padding: '0px', marginBottom: '1px' }" v-for="item in skeletonLists" :key="item.name">
